...
class UserProfileTestProvider
{
    ...
    /**
     * Auth response + profile response.
     *
     * @return ResponseInterface[]
     */
    public static function getProfileSuccess(): array
    {
        ...
        return [
            ...
            $factory->createResponse(200)
                ->withHeader('Content-Type', 'application/json')
                ->withBody($factory->createStream(self::loadFixture('userprofile/success.json'))),
        ];
    }
}
